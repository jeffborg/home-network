...
output "smtp_host" {
  value = "email-smtp.${local.aws_region}.amazonaws.com:587"
}

output "smtp_user" {
  value = aws_iam_access_key.credentials_for_smtp_user.id
}

output "smtp_pass" {
  value = aws_iam_access_key.credentials_for_smtp_user.ses_smtp_password_v4
  sensitive = true
}
